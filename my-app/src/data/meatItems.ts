...
export const meatItems: MeatItem[] = [
  {
    ...
    price: 29.99,
    image: "https://images.unsplash.com/photo-1615937657715-bc7b4b7962c1?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80",
    description: "Perfectly marbled, premium cut ribeye",
    details: {
      origin: "Black Angus cattle from premium farms",
      weight: "300g per portion",
      preparation: "Dry-aged for 28 days, seasoned with our signature spice blend",
  ...
  },
  {
    ...
    name: "Beef Brisket",
    price: 22.99,
    image: "https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80",
