        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl text-center mx-auto text-white">
            ...
            <p className="text-lg mb-12 text-gray-200">
              Premium cooked meat for your next gathering. The more people you
              bring, the less each pays. Freshly grilled, perfectly seasoned,
              ready to enjoy!
            </p>
            <Link
              to="/catalog"
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white p-6 rounded-lg shadow-md text-center">
            ...
            <p className="text-gray-600">
              20+ varieties of perfectly grilled premium meats
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md text-center">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 mb-16">
          <div className="flex-1">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Get an instant quote for your group. The more people join, the
              better the deal gets! Each person gets a generous 500g portion of
              mixed premium meats.
            </p>
