        ...
        <div>
          ...
          <div className="mt-8 grid grid-cols-3 gap-4">
            ...
            <div className="bg-orange-50 p-4 rounded-lg text-center">
              ...
              <p className="text-sm text-gray-600">{item.details?.preparation}</p>
            </div>
            <div className="bg-orange-50 p-4 rounded-lg text-center">
        ...
        <div>
          ...
          {item.details && (
            <div className="space-y-8">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4">Perfekte Beilagen</h3>
              ...
              {item.details.nutritionalInfo && (
                <div>
                  <h3 className="text-xl font-semibold mb-4">Nährwertangaben</h3>
                  <div className="grid grid-cols-3 gap-4">
                    <div className="bg-orange-50 p-4 rounded-lg text-center">
                      <p className="text-sm text-gray-600">Protein</p>
                      <p className="font-bold text-orange-600">{item.details.nutritionalInfo.protein}</p>
                    </div>
                    <div className="bg-orange-50 p-4 rounded-lg text-center">
                      <p className="text-sm text-gray-600">Fett</p>
                      <p className="font-bold text-orange-600">{item.details.nutritionalInfo.fat}</p>
                    </div>
                    <div className="bg-orange-50 p-4 rounded-lg text-center">
                      <p className="text-sm text-gray-600">Kalorien</p>
                      <p className="font-bold text-orange-600">{item.details.nutritionalInfo.calories}</p>
                    </div>
                  </div>
                </div>
              )}
